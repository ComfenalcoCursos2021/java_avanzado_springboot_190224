...
public class UsuarioControlador {
	...
	@PutMapping("/{id}")
	public ResultadoUsuarioDto actualizarUsuario(@PathVariable int id, @RequestBody UsuarioDto usuarioDto) {
		usuarioDto.setId(id);
		ResultadoUsuarioDto usuarioResultadoDto = usuarioServicio.actualizar(usuarioDto);
