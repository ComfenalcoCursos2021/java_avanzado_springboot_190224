...
public class UsuarioDal {
	...
	public List<UsuarioEntidad> consultarPorApellido(String apellido) {
		
		List<UsuarioEntidad> listaEntidades = conexionUsuarioBaseDatos.findByApellidoLike("%" + apellido + "%");
		return listaEntidades;
	}
	
	public List<UsuarioEntidad> consultarPorApellidoConTelefono1(String apellido) {
		///OPCION 1
		List<UsuarioEntidad> listaEntidades = conexionUsuarioBaseDatos.findByApellidoLikeAndTelefono("%" + apellido + "%","1");
		return listaEntidades;
	}
}
